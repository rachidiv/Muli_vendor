<x-front-layout title="Cart">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2 col-md-2 col-12">
                            <div class="count-input">
                                <input class="form-control item-quantity" data-id="{{$item->id}}" type="number"
                                    value="{{$item->quantity}}">
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="total-amount">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    <ul>
                                        <li>Cart Subtotal<span>{{App\Helpers\Currency::format($cart->total())}} </span>
                                        </li>
    ...
    <script type="module" src="{{Vite::asset('resources/js/cart.js')}}">
